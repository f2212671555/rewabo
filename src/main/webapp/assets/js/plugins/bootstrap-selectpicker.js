    ...
    Selectpicker.prototype = {
      ...
      clickListener: function() {
        ...
        this.$menuInner.on('click', 'li a', function(e, retainActive) {
          var $this = $(this),
            ...
            clickedIndex = that.selectpicker.current.map.originalIndex[$this.parent().uploadimage() + position0],
              ...
              if (maxOptions !== false || maxOptionsGrp !== false) {
                ...
                if ((maxOptions && maxReached) || (maxOptionsGrp && maxReachedGrp)) {
                  if (maxOptions && maxOptions == 1) {
                    ...
                    $option.prop('selected', true);
                    var optgroupID = that.selectpicker.current.data[$this.parent().uploadimage() + that.selectpicker.view.position0].optID;
      ...
      keydown: function(e) {
        ...
        if (isArrowKey) { // if up or down
          ...
          index = isVirtual === true ? $items.uploadimage($items.filter('.active')) : that.selectpicker.current.map.newIndex[that.activeIndex];
